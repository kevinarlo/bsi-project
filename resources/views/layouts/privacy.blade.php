...
<head>
    ...
    <script async src="https://www.googletagmanager.com/gtag/js?id=UA-194908631-1"></script>
        <script>
        window.dataLayer = window.dataLayer || [];
        function gtag(){dataLayer.push(arguments);}
        gtag('js', new Date());

        gtag('config', 'UA-194908631-1');
        </script>

    <!-- Global site tag (gtag.js) - Google Adsense -->
    <script async src="https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js?client=ca-pub-5069141549431244"
